...
/**
 * Handler to invoke operation of bootstrapAwsIotThing
 * 
 * @author c9katayama
 *
 */
public class BootstrapAwsIotThingOperationHandler implements KryptonOperationHandler<BootstrapAwsIotThingResult> {

	@Override
	public OperationInfo getOperationInfo() {
		return new OperationInfo("bootstrapAwsIotThing", "Bootstrap AWS IoT Things");
	}
