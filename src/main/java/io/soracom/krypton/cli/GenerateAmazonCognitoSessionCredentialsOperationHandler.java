...
public class GenerateAmazonCognitoSessionCredentialsOperationHandler
		implements KryptonOperationHandler<GenerateAmazonCognitoSessionCredentialsResult> {

	@Override
	public OperationInfo getOperationInfo() {
		// TODO Auto-generated method stub
		return new OperationInfo("generateAmazonCognitoSessionCredentials",
				"Generate AWS temporary session token by Amazon Cognito");
	}
