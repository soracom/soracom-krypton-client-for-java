...
public class GenerateAmazonCognitoOpenIdTokenOperationHandler
		implements KryptonOperationHandler<GenerateAmazonCognitoOpenIdTokenResult> {

	@Override
	public OperationInfo getOperationInfo() {
		return new OperationInfo("generateAmazonCognitoOpenIdToken", "Generate open id token by Amazon Cognito");
	}
